...
var handlePanelAction = function() {
    ...
    $("[data-click=panel-edit]").hover(function() {
        $(this).tooltip({
            title: "添加",
            placement: "bottom",
            trigger: "hover",
