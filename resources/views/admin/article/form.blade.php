<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            {!! Form::select('category[]', $categoryList, isset($articleCategory) ? $articleCategory : null, ['class' => 'form-control selectized', 'id' => 'category', 'placeholder' => '请选择文章分类', 'tabindex' => '-1', 'multiple' => 'multiple']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            {!! Form::select('tags[]', $tagList, isset($articleTag) ? $articleTag : null, ['class' => 'form-control selectized', 'id' => 'tags', 'placeholder' => '请选择文章分类', 'tabindex' => '-1', 'multiple' => 'multiple']) !!}
        </div>
    </div>
