                            ...
                            @foreach($permissionList as $index => $item)
                                <tr>
                                    ...
                                    <td style="width: 170px;;">
                                        <a data-click="permission-edit"
                                           data-url="{{route('admin.acl.permission.edit', ['id' => $item->id])}}"
                                           href="javascript:;" class="btn btn-primary btn-xs"><span
                                                    class="fa  fa-edit"></span> 编辑 </a>
                                        <a href="javascript:;" data-value="{{$item->id}}" class="btn btn-danger btn-xs"
                                           data-click="permission-remove"><span class="fa fa-trash-o"></span> 删除 </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                    ...
                    <div class="panel-heading">
                        <div class="panel-heading-btn">
                            ...
                            <a href="{{route('admin.category.create')}}"
                               class="btn btn-xs btn-icon btn-circle btn-primary" data-click="panel-edit"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm btn-warning ladda-button" data-click="permission-save"
                            data-style="zoom-in"><span class="ladda-label">保存</span></button>
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    <script>
        ...
        var loader;
        $(document).on('click', '[data-click=permission-remove]', function (e) {
            e.preventDefault();
            form_data.remove({
